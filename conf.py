...
BLOG_TITLE = "Sky is no longer the limit"  # (translatable)
SITE_URL = "https://blog.lambda-my-aws.io/"
# BASE_URL = "https://blog.lambda-my-aws.io/"
BLOG_EMAIL = "JohnPreston@users.noreply.github.com"
BLOG_DESCRIPTION = "When CloudFormation and Lambda team up."  # (translatable)
DEFAULT_LANG = "en"
...
# is in the manual.
COMMENT_SYSTEM_ID = "lambda-my-aws"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-86753837-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-86753837-2');
</script>
"""
